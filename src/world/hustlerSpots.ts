...
export const METRO_HUSTLER_SPOTS: HustlerSpot[] = [
  ...
  {
    // Moved from st-oldtown × st-s5 when the south lost its grid (`metroSouth.ts`): neither street runs there now.
    id: 'trapito-e3-s5',
    kind: 'trapito',
    label: 'ST EAST 3 × ST S5',
    x: 467,
    z: 928.7,
    heading: N,
    seed: 57,
    space: { x: 461.5, z: 924.2 },
    signal: { x: 472.7, z: 927.3, heading: W, offset: 9 },
  },
  {
    // Moved up from st-s4, which no longer crosses st-centre (`metroSouth.ts`).
    id: 'trapito-centre-s1',
    kind: 'trapito',
    label: 'ST CENTRE × AV S1',
    x: 43,
    z: 488.8,
    heading: S,
    seed: 9,
    space: { x: 48.5, z: 493.3 },
    signal: { x: 37.3, z: 490.2, heading: E, offset: 24 },
  },
  {
  ...
  {
    // Moved up from st-s6, which the Costanera replaced (`metroSouth.ts`).
    id: 'trapito-ring-e-s2',
    kind: 'trapito',
    label: 'RING E × AV S2',
    x: 327.8,
    z: 764.5,
    ...
    seed: 61,
    space: { x: 332.3, z: 759 },
    signal: { x: 329.2, z: 770.2, heading: N, offset: 37 },
  },
  {
    id: 'trapito-e3-s3',
    kind: 'trapito',
