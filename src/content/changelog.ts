...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    items: [
      ...
      'The park rolls now: hills and knolls, and a walk along the lake road lit by rows of bollard lamps.',
      'The park after the drizzle: darker woods, and damp, patchy lawns that catch the lamps and the neon.',
      ...
      'Rayo Rush\'s daily attempt cap is gone: every run counts and can move you up the board.',
